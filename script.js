...
function editar(numero){
    ...
    if (numfila <= 1) {
        ...
        editar_porcentaje.innerHTML = "<input class='form - control' type='text' aria-label='default input example' size='2' name='porcentaje_data' id='porcentaje" + numero + "value='" + porcentaje_data + "'>";

        editar_fila.innerHTML ="<span style='color:#a29ea0; font-weight: 500;'>En edicion</span>";
